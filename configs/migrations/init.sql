...
GRANT USAGE            ON                       SCHEMA public TO bonus_program;
GRANT ALL   PRIVILEGES ON ALL      TABLES    IN SCHEMA public TO bonus_program;
GRANT ALL   PRIVILEGES ON ALL      SEQUENCES IN SCHEMA public TO bo nus_program;
FLUSH PRIVILEGES;
